...
$(document).ready(function () {
  $('#mob_reg_can').click(function () {
    $('.mob_fir_frm').css("bottom", "-110%");
    $('html').css("position", "static");
  });

  $('#mob_reg_can').click(function () {
    $('#mob_show_reg').css("bottom", "-110%");
  });
});
...
$(document).ready(function () {
  $('#mob_forget_can').click(function () {
    $('#mob_show_forget').css("bottom", "-110%");
    $('html').css("position", "static");
  });
});
